\chapter[Fussballszenario]{Fussballszenario \hfill\raggedleft{\normalsize A.G.}} \label{kap:Fussballszenario} %TODO: Besseren Kapiteltitel
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=\textwidth]{Final_FSM_AMiRo.pdf}
...
Wird mindestens ein Pixel dem Ball zugeordnet, ist die Detektion erfolgreich. Nun können weitere Eigenschaften des detektierten Balls berechnet werden.
...
Je Größer der Ball im Bild, desto langsamer wird er angefahren.
Desto größer der Abstand zwischen Bildmittelpunkt und Ballmittelpunkt, desto schneller wird rotiert.
...
Ein weiterer, jedoch nicht getesteter, Ansatz ist, dass Bild zu erodieren und abermals zu dilatieren. Diese morphologische Operation, genannt \textit{Closing}, schließt Lücken im Vordergrund. Diese Operationen sind jedoch aufwendig und würden ebenfalls zu Verzögerungen beim Anfahren des Balls führen.
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=.6]{cheer_rnd_stage_switch.png} 	
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[scale=.6]{cheer_chaser_single_grp.png} 	
